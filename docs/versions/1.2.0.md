...
12. (a) The value of a `valueURI` attribute MUST be a term URI that is part of the controlled vocabulary specified in the `schemeURI` attribute of the same element.
