...
3. The `bag-info.txt` file MAY contain exactly one element called `Data-Station-User-Account`. If provided, it MUST
   contain the user name of the Data Station account that is authorized to deposit the bag.
